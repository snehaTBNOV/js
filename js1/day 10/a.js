...
for(i=0; i<productList.length; i++)
{
  if(productList[i].isAccessory===false){
      ...
      var clothBrand = document.createElement("div");
      clothBrand.className = "cloth-brand";
      clothBrand.innerHTML = productList[i].brand;

      var clothPrice = document.createElement("div")
      clothPrice.className = "card-price"
      clothPrice.innerHTML ="RS " + productList[i].price;



      imgDiv.appendChild(modelImage);
      detailsdiv.appendChild(cardHeading);
      detailsdiv.appendChild(clothBrand);
      detailsdiv.appendChild(clothPrice);
...
var headerTag1 = document.createElement("h2");
headerTag1.innerHTML = "Accessories for Men and Women";
headerTag1.className = "header-tag1"
mainsection.appendChild(headerTag1);


//Accessories section

var AccSection = document.createElement("div");
AccSection.className = "Acc-id";
...
for(i=0; i<productList.length; i++)
{
  if(productList[i].isAccessory===true){
      ...
      cardLink1.href = "#";
      AccCard.appendChild(cardLink1);

      var imgDiv1 = document.createElement("div")
      imgDiv1.className = "img-Div1";

      var modelImage1 = document.createElement("img")
      modelImage1.className = "model-image1";
      modelImage1.src = productList[i].preview;

      var detailsdiv1 = document.createElement("div");
      detailsdiv1.className = "details-div1";

      var cardHeading1 = document.createElement("div")
      cardHeading1.className = "card-header";
      cardHeading1.innerHTML = productList[i].name;

      var clothBrand1 = document.createElement("div");
      clothBrand1.className = "cloth-brand";
      clothBrand1.innerHTML = productList[i].brand;

      var AccPrice = document.createElement("div")
      AccPrice.className = "card-price"
      AccPrice.innerHTML ="RS " + productList[i].price;

      imgDiv1.appendChild(modelImage1);
      detailsdiv1.appendChild(cardHeading1);
      detailsdiv1.appendChild(clothBrand1);
      detailsdiv1.appendChild(AccPrice);
      cardLink1.appendChild(imgDiv1);
      cardLink1.appendChild(detailsdiv1);
      AccSection.appendChild(AccCard);
  }
}
mainsection.appendChild(AccSection)