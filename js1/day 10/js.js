...
//main container 
  var mainSection = document.getElementById("cloth-acc")
 //header
  var header=document.createElement("h2") //create h2
  header.innerHTML="Clothing for Men and Women"
  //then create class for applying css
  ...
  //just check the product list is accessories or not
  for (var i=0;i<productList.length;i++){
    if(productList[i].isAccessory===false){

      var clothCard=document.createElement("div") //create a div
      clothCard.className="cloth-card"
      var cardLink=document.createElement("a")//create a card link 
      cardLink.href="#" 
      clothCard.appendChild(cardLink)

//each card has images and details 
      var imge=document.createElement("div")
      imge.className="img-div"
      
      var modelimage=document.createElement("img")
      modelimage.className="model-img"
      modelimage.src=productList[i].preview

      var details=document.createElement("div")
      details.className="detail-div"
     ...
     price.className="prices"
      ...
      imge.appendChild(modelimage)
      details.appendChild(cardHeading)
      brand.appendChild(brandname)
      pri.appendChild(price)

      cardLink.appendChild(imge)
      clothCard.appendChild(details)
      clothCard.appendChild(brand)
      clothCard.appendChild(pri)
 ...
 //header
  var header1=document.createElement("h2") //create h2
  header1.innerHTML="Accessories for Men and Women"
  //then create class for applying css
  header1.className="header-tag1"
  mainSection.appendChild(header1)


  //acc

  var acSection =document.createElement("div")
  acSection.className="ac-id"

  //just check the product list is accessories or not
  for (i=0;i<productList.length;i++){
    if(productList[i].isAccessory===true){

      var acCard=document.createElement("div") //create a div
      acCard.className="ac-card"
      var cardLink1=document.createElement("a")//create a card link 
      cardLink1.href="#" 
     acCard.appendChild(cardLink1)

//each card has images and details 
      var imge1=document.createElement("div")
      imge1.className="img-div1"
      
      var modelimage1=document.createElement("img")
      modelimage1.className="model-img1"
      modelimage1.src=productList[i].preview

      var details1=document.createElement("div")
      details1.className="detail-div1"

      var cardHeading1=document.createElement("div")
      cardHeading1.className="card-heading1"
      cardHeading1.innerHTML=productList[i].name

      var brand1=document.createElement("div")
      brand1.className="brand-div1"

      var brandname1=document.createElement("div")
      brandname1.className="brand-name1"
      brandname1.innerHTML=productList[i].brand

      var pri1=document.createElement("div")
      pri1.className="pri-div1"

      var price1=document.createElement("div")
     price1.className="prices1"
      price1.innerHTML= "Rs.  " + productList[i].price


      imge1.appendChild(modelimage1)
      details1.appendChild(cardHeading1)
      brand1.appendChild(brandname1)
      pri1.appendChild(price1)

      cardLink1.appendChild(imge1)
      acCard.appendChild(details1)
   acCard.appendChild(brand1)
      acCard.appendChild(pri1)

      acSection.appendChild(acCard)

    }
  }
  mainSection.appendChild(acSection)