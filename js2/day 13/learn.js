...
var leftimg=document.getElementById("productImg")

leftimg.src=document.getElementById("img0").src
...
document.getElementById("img1").addEventListener("click", function() {
    leftimg.src =  document.getElementById("img1").src;
...
document.getElementById("img2").addEventListener("click", function() {
    leftimg.src =  document.getElementById("img2").src;
...
document.getElementById("img3").addEventListener("click", function() {
    leftimg.src =  document.getElementById("img3").src;
...
document.getElementById("img4").addEventListener("click", function() {
    leftimg.src =  document.getElementById("img4").src;
...
document.getElementById("img5").addEventListener("click", function() {
    leftimg.src =  document.getElementById("img5").src;
